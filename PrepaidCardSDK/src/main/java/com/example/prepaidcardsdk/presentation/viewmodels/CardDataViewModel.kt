...
class CardDataViewModel @Inject constructor(
    ...
    fun cardDataByCustomer(onComplete: (CardDataByCustomerResp?) -> Unit){

        viewModelScope.launch {
            handleFlow<CardDataByCustomerResp>(
                response = cardDataByCustomerUseCase.invoke("http://35.200.225.250:8080/cardissuer/cms/viewCarddataByCustomer", requestModel = CardDataRequestModel()),
