...
@Composable
fun PageTen(rootNavController: NavHostController, viewModel: GeneratePinViewModel, onClick: (state:Boolean) -> Unit = {}) {
   ...
   @Composable
    ...
    CustomScaffoldScreen(
        ...
        enterOtp = EnterOTPToggleState,
        pauseCard =  PauseCardToggleState,
