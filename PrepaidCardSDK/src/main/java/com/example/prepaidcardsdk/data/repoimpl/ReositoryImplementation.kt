...
class RepositoryImplementation @Inject constructor(val apiService: APIService):Repository {
    ...
    override fun changeCardStatus(otp: String, cardStatus: String): Flow<NetworkResponse<ChangeStatusResponseModel>> {
        val reqBody= ChangeStatusRequestModel(cardRefId = SDK_CONSTANTS.cardRefId?:"168", cardStatus = cardStatus,otp, mobileNUmber = SDK_CONSTANTS.mobileNumber)
    ...
    override fun resetPin(pin: String, otp: String): Flow<NetworkResponse<ResetPinResponseModel>> {
        ...
        val reqbody = ResetPinRequestModel(encryptPin = encPin, otp = otp , mobilNumber = SDK_CONSTANTS.mobileNumber)
    ...
    override fun viewCvv(otp: String): Flow<NetworkResponse<ViewCvvResponseModel>> {
       ...
       val reqBody=ViewCvvRequestModel(otp = otp, cardRefNumber = SDK_CONSTANTS.cardRefId?:"", mobileNumber = SDK_CONSTANTS.mobileNumber)
