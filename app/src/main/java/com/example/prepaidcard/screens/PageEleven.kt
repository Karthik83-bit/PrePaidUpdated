...
@Composable
fun PageEleven(rootNavController: NavHostController, onClick: (state:Boolean) -> Unit = {}) {
            ...
            Column(modifier = Modifier
                ...
                Row(
                    ...
                    list.forEachIndexed { index, s ->
                        Text(s,
                            Modifier.clickable { clickedState.value=s }, color = if(s!=clickedState.value) ColorReset else{
                            Color(0xFFDB8726)
                        },
